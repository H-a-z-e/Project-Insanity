...
public class Config {
	...
	public static final String SERVER_NAME = "eScape";
	public static final String WELCOME_MESSAGE = "Haze Is Back";
	public static final String FORUMS = "";
	
	public static final int CLIENT_VERSION = 1;
	
	public static int MESSAGE_DELAY = 6000;
	public static final int ITEM_LIMIT = 24000; // item id limit, different clients have more items like silab which goes past 15000
