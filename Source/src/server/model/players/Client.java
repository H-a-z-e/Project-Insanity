...
public class Client extends Player {
	...
	public void process() {
		...
		getPA().sendFrame126(
				...
				29161); // quest title
		// getPA().sendFrame126("" + playerLevel[24] + "", 4017);
		...
		getPA().sendFrame126("" + getPA().getLevelForXP(playerXP[24]) + "",
				29801);
		/*
		 * if (wcTimer > 0) { wcTimer--; } else if (wcTimer == 0 && woodcut[0] >
		 * 0) { getWoodcutting().cutWood();
		 */
		/*
		...
		if (smeltTimer > 0 && smeltType > 0) {
			...
			/*
			 * } else if (fishing && fishTimer > 0) { fishTimer--; } else if
			 * (fishing && fishTimer == 0) { getFishing().catchFish();
			 */
		}
