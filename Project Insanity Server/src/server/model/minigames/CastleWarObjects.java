...
public class CastleWarObjects {
	...
	public void handleObject(final Client c, final int id, final int x, final int y) {
		switch (id) {
		...
		case 4469:
			...
			if (x == 2426) {
				if (c.getY() == 3080) {
					c.getPA().movePlayer(2426, 3081, Player.heightLevel);
				} else if (c.getY() == 3081) {
					c.getPA().movePlayer(2426, 3080, Player.heightLevel);
				}
			} else if (x == 2422) {
				if (c.getX() == 2422) {
					c.getPA().movePlayer(2423, 3076, Player.heightLevel);
				} else if (c.getX() == 2423) {
					c.getPA().movePlayer(2422, 3076, Player.heightLevel);
				}
			}
			break;
