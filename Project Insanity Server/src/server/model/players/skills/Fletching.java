...
public class Fletching {
	...
	public Fletching(final Client c) {
		this.c = c;
	}

	public void fletchBow(final int index) {
	...
	public int getAmountToAdd(final int id) {
		if (id == 52) {
			return 15;
		} else {
			return 1;
	...
	public int getExp(final int index) {
		if (fletchType == 3) {
			return 5;
	...
	public int getItemToAdd(final int index) {
		if (fletchType == 3) {
			return shaft;
		} else if (fletchType == 1) {
	...
	public void handleFletchingClick(final int clickId) {
	...
	public void handleLog(final int item1, final int item2) {
		if (item1 == 946) {
			openFletching(item2);
		} else {
			openFletching(item1);
	...
	public void openFletching(final int item) {
		if (item == 1511) {
