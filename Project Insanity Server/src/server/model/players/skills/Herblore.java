...
public class Herblore {
	...
	private final int[][] information = {
			{199,249,1,3},{201,251,5,4},{203,253,11,5},{205,255,20,6},{207,257,25,8},
	...
	private final int[][] information2 = {
			{249,121,2428,1,25},{251,175,2446,5,38},{253,115,113,12,50},{255,127,2430,22,63},
			{257,139,2434,38,88},{261,2448,2448,40,100},{259,145,2436,45,100},{263,157,2440,55,125},
			{3000,3026,3024,63,143},{265,163,2442,66,155},{2481,2454,2452,69,158},{267,169,2444,72,163},
			{269,189,2450,78,175},{2998,6687,6685,81,180}
	};

	public Herblore(final Client c) {
		this.c = c;
	}

	private int getSlot(final int herb) {
	...
	public void handleHerbClick(final int herbId) {
	...
	public void handlePotMaking(final int item1, final int item2) {
	...
	public boolean isIdedHerb(final int item) {
		for (final int[] element : information2) {
			if (element[0] == item) {
				return true;
			}
		}
	...
	public boolean isUnidHerb(final int clickId) {
		for (final int[] element : information) {
	...
	private void makePot(final int herbId) {
