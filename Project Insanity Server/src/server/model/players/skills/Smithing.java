...
public class Smithing {
	...
	private void CheckAddy(final Client c, final int level, final int amounttomake, final String type) {
		remove = 2361;
	...
	private void CheckBronze(final Client c, final int level, final int amounttomake,final String type) {
	...
	private void CheckIron(final Client c, final int level, final int amounttomake, final String type) {
		remove = 2351;
	...
	private void CheckMith(final Client c, final int level, final int amounttomake, final String type) {
		remove = 2359;
	...
	private void CheckRune(final Client c, final int level, final int amounttomake, final String type) {
		remove = 2363;
	...
	private void CheckSteel(final Client c, final int level, final int amounttomake, final String type) {
		remove = 2353;
	...
	public boolean doAction(final Client c, final int toadd, final int toremove, final int toremove2, final int timestomake, final int NOTUSED, final int NOTUSED2, final int xp) {
	...
	public void readInput(final int level, final String type, final Client c, final int amounttomake) {
