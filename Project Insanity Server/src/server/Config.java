...
public class Config {
	...
	public static final String SERVER_NAME = "Project Insanity Cleaned";
	public static final String WELCOME_MESSAGE = "Welcome to Eddie's Project";
	...
	public static final int MELEE_EXP_RATE = 2000000; // damage * exp rate
